...
public class UnknownDataColumnSpecBuilder implements IPEMColumnSpecBuilder {
    ...
    private final String[] COLUMN_HEADERS = { "ID", "Name", "Date",
            "Time (UTC)", "Lon", "Lat", "Km to Coast", "Source" };

    /*
     * COLUMN_HEADER, COLUMN_WIDTHS, and COLUMN_STRING_BUILDERS should all have
     * the same length. They are used in the ColumnSpec(ifications).
     */
    private final int[] COLUMN_WIDTHS = { 160, 120, 95, 83, 80, 80, 120, 65 };
    ...
    public UnknownDataColumnSpecBuilder() {
        /*
