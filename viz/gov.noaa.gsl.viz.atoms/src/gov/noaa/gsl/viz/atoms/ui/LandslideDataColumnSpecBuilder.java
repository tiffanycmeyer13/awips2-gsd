...
public class LandslideDataColumnSpecBuilder implements IPEMColumnSpecBuilder {
     ...
     * the same length. They're used in the ColumnSpec(ifications).
     */
    ...
    public LandslideDataColumnSpecBuilder() {
        /*
