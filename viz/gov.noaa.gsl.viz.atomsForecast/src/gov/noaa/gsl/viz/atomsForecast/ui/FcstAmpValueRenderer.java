...
/**
 * This render is for display the station forecasts' amplitude string in the
 * map.
 *
 * <pre>
 *
 ...
 * @version 1.0
 */
public class FcstAmpValueRenderer {
    ...
    public FcstAmpValueRenderer(TsunamiStationForecast forecast) {
    ...
    public void plot(IGraphicsTarget target, IMapDescriptor descriptor,
        ...
        String plotStr = "";
        if (((Float) stnFcst.getAmplitude()).isNaN()) {
            plotStr = "NaN";
        } else {
            plotStr = AMP_FORMATTER.format(stnFcst.getAmplitude()) + "m";
        }
        DrawableString plot = new DrawableString(" " + plotStr, color);
