...
/**
 * This render is for display the station forecasts' station name string in the
 * map.
 *
 * <pre>
 *
 ...
 * @version 1.0
 */
public class ForecastStationNameRenderer {

    private TsunamiStationForecast stnFcst;

    private Capabilities drawCapabilities = null;

    public ForecastStationNameRenderer(TsunamiStationForecast forecast) {
    ...
    public void plot(IGraphicsTarget target, IMapDescriptor descriptor,
        ...
        DrawableString plot = new DrawableString(
                " " + stnFcst.getStation().getName(), color);
