...
public class DefaultPEMColumnSpecBuilder implements IPEMColumnSpecBuilder {
    ...
    private final String[] COLUMN_HEADERS = { "ID", "Name", "Date",
            "Time (UTC)", "Lon", "Lat", "Km to Coast", "Type", "Known",
            "Source" };
     ...
     * the same length. They are used in the ColumnSpec(ifications).
     */
    private final int[] COLUMN_WIDTHS = { 165, 165, 100, 83, 80, 80, 120, 90,
            55, 65 };
    ...
    private final Comparator[] COLUMN_COMPARATORS = {
            ...
            (Object e1, Object e2) -> ((IPhysicalEvent) e1).getEventType()
                    .toString()
                    .compareTo(((IPhysicalEvent) e2).getEventType().toString()),
            (Object e1,
    ...
    public DefaultPEMColumnSpecBuilder() {
        /*
    ...
    /**
     * Null means all, meaning that only the generic-to-the-PhysicalEvent-class
     * columns will be returned, and nothing specific to subclasses (such as
     * Seismic).
     */
    @Override
