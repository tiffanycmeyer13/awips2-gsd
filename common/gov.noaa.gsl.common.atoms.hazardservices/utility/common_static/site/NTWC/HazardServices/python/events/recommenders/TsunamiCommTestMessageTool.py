...
# -- Levels: All
"""
Tsunami Comms Test Message Tool (NTWC)
...
class Recommender(TsunamiRecommenderCommon.TsunamiRecommenderCommon):
    ...
    def __init__(self):
        ...
        self.logger.addHandler(UFStatusHandler.UFStatusHandler(
            "gov.noaa.gsl.common.atoms.hazardservices", "TsunamiCommTestMessageTool", level=logging.INFO))
    ...
    def defineScriptMetadata(self):
        ...
        '''
        metaDict = {
            "toolName": "TsunamiCommTestMessageTool (NTWC)",
            "author": "GSL",
            "version": "1.0",
    ...
    def defineDialog(self, eventSet, **kwargs):
        ...
        selectedEvent.setSource("NTWC")
        selectedEvent.setLatitude(39.0)
    ...
    def getTsunamiCommTestMessageRegionChoices(self):
        return [
            {"identifier": "AtlanticPublic", "displayString": "Atlantic Public"},
            {"identifier": "AtlanticSegmented", "displayString": "Atlantic Segmented"},
            {"identifier": "PacificPublic", "displayString": "Pacific Public"},
            {"identifier": "PacificSegmented", "displayString": "Pacific Segmented"},
            {"identifier": "Alaska", "displayString": "Alaska"}
            ]
