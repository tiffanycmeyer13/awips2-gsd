# *** Override behavior of MetaData_TS_ObservMsg.py ***
...
class MetaData(CommonMetaData.MetaData):
    ...
    def getCustomId(self):
        '''
        @summary: Creates the Text box for the "Physical event" megawidget
        @return: Dictionary of megawidget properties
        '''
        defaultValue = self.cmdTsu.getDefaultCustomId(self.hazardEvent)
        return {
            "fieldType": "Text",
            "fieldName": "customId",
