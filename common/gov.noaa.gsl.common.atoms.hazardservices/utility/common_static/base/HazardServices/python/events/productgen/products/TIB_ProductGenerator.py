# *** Override behavior of TIB_ProductGenerator.py ***
# -- Override ability: Class-based
# -- Levels: All
'''
    Description: Product Generator for the Tsunami Information products.
...
class Product(NWS_Base_Generator.Product):
    ...
    def __init__(self):
        ...
        self.productGeneratorName = "TIB_ProductGenerator"

    def initialize(self):
        super(Product, self).initialize()
        self.productID = "TIB"
        self.productCategory = "TIB"
        self.productName = "Tsunami Information Statement"
        self.productLabel = "Tsunami Information Statement"
    ...
    def defineScriptMetadata(self):
        ...
        return {
            "author": "GSL",
            "description": "Product generator for the Tsunami Information Statement",
            "version": "1.0",
            }
