...
/**
 *
 * A station representing a point for sea level observations.
 *
 * NOTE Originally this class was the same as the Tsunami Forecast Station, but
 * the metadata for both stations was dramatically different, and hence, I split
 * the stations into two different classes. Also, there is no inheritance
...
@DynamicSerialize
@Entity
@Table(name = "sea_level_station", uniqueConstraints = {
        @UniqueConstraint(columnNames = { "customId" }) })
public class SeaLevelStation implements ILonLat {
    ...
    public boolean equals(Object obj) {
        ...
        SeaLevelStation other = (SeaLevelStation) obj;
